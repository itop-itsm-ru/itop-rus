...
При ассоциации с триггером, каждое действие получает "порядковый" номер, который определяет порядок выполнения действий.</p>',
	...
	'UI:Dashboard:RevertConfirm' => 'Будет возвращена оригинальная версия приборной панели. Все изменения будут утеряны. Хотите продолжить?',
	...
	'UI:DashboardEdit:Title' => 'Редактор панели',
	...
	'UI:DashboardEdit:Properties' => 'Свойство панели',
	'UI:DashboardEdit:Dashlets' => 'Доступные дашлеты',	
	'UI:DashboardEdit:DashletProperties' => 'Свойство дашлета',	
	...
	'UI:DashletPlainText:Prop-Text:Default' => 'Здесь введите текст...',

	'UI:DashletObjectList:Label' => 'Список',
	'UI:DashletObjectList:Description' => 'Список',
